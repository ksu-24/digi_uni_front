    ...
    theme: {
        extend: {
            ...
            animation: {
                ...
                "slide-left": "translate-from-right 0.6s cubic-bezier(0,0,.15,.99) forwards",
                "slide-right": "translate-from-left 0.6s cubic-bezier(0,0,.15,.99) forwards",
                "slide-down": "translate-from-top 0.6s cubic-bezier(0,0,.15,.99) forwards",
                "slide-up": "translate-from-bottom 0.6s cubic-bezier(0,0,.15,.99) forwards",
                "grow": "grow 0.6s cubic-bezier(0,0,.15,.99) forwards",
            },
            backgroundColor: {
